...
- `dist/wasm-files/web-demuxer.wasm`: 完整版(gzipped: 1131 kB), 体积较大，支持mov,mp4,m4a,3gp,3g2,mj2,avi,flv,matroska,webm,m4v,mpeg,asf,mpegts
- `dist/wasm-files/web-demuxer-mini.wasm`: 精简版本(gzipped: 493 kB)，体积小，仅支持mov,mp4,m4a,3gp,3g2,matroska,webm,m4v
